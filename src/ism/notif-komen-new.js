...
// Retoch by Kang Ismet

var cm_config_defaults = {
	home_page: "https://kang-ismet.com",
	max_result: 7,
	t_w: 32,
	t_h: 32,
	summary: 9999,
...
function showRecentComments(json) {
 ...
 skeleton = '<ul class="cm-outer">';
	for (var i = 0; i < entry.length; i++) {
		...
		skeleton += '<li>';
		skeleton += '<div class="cm-header"><a href="' + link + '" title="' + title + '"' + nt + '>' + name + '</a><div class="tgl">' + date + '</div></div>';
		...
		skeleton += '<span class="cm-text"><a href="' + link + '" title="' + title + '"' + nt + '>' + content + '</a></span>';
		skeleton += '</div></li>';		
	}
	skeleton += '</ul>';
